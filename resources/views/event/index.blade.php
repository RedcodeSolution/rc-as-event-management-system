                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                            <div class="mt-10 ml-10 grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-6">
                              ...
                              <div class="sm:col-span-4">
                                  ...
                                  <div class="mt-2">
                                      <input id="location" name="location" type="text" autocomplete="off" class="block w-80 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                  </div>
                              </div>
